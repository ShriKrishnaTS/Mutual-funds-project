...
$(document).on("click",'#Amc_mst_btn', function() {
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_amc_msts',
						datatype:'json',
...
$(document).on("click",'#aum_total_btn', function() {
   ...
   $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_aum_totalvalue',
						datatype:'json',
...
function scheme_name()
{
	$.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_scheme_name',
						datatype:'json',
...
function current_nav()
{
	   $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_current_nav_value',
						datatype:'json',
...
function get_fundmanager()
{
	 $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_fund_manager',
						datatype:'json',
...
function inception()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_inception_date',
						datatype:'json',
						success:function(data1, textStatus, jqXHR) {
  console.log(data1);
...
function exitload()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_exit_load',
						datatype:'json',
...
function expenseratio()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_expense_ratio',
						datatype:'json',
...
function inceptionre()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_inception_return',
						datatype:'json',
...
function turnoverratio()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_turnover_ratio',
						datatype:'json',
...
function mininvestment()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/functionalities/get_minimum_investment',
						datatype:'json',
...
function mcap_classification()
{
  $.ajax({
						type:'GET',
						url: 'http://localhost:3000/mcap_classification/get_mcap_classification',
						datatype:'json',
						success:function(data1, textStatus, jqXHR) {
  console.log(data1);
  var tblData;
...
function schemedata_landing1()
{
   ...
   for(var i =0;i <= data1.schemedata.length-1;i++)
  {
	...
	if(i == 0)
	{
		tblData = document.getElementById("tblData").innerHTML + "<tr><td><input type='checkbox' /></td><td id="+scheme_code+"><a href='http://localhost:3000/home/index_latest?scheme_code="+scheme_code+"'>"+scheme_name+"</a></td><td></td><td>"+scheme_aum_total+"</td><td>"+scheme_year1+"</td><td>"+scheme_year3+"</td><td>"+scheme_year5+"</td><td>"+exratio+"</td><td>"+high_sec_alloc+"</td></tr>";
	}
	else
	{
		tblData = tblData + "<tr><td><input type='checkbox' /></td><td id="+scheme_code+"><a href='http://localhost:3000/home/index_latest?scheme_code="+scheme_code+"' >"+scheme_name+"</a></td><td></td><td>"+scheme_aum_total+"</td><td>"+scheme_year1+"</td><td>"+scheme_year3+"</td><td>"+scheme_year5+"</td><td>"+exratio+"</td><td>"+high_sec_alloc+"</td></tr>";
	}
  }
